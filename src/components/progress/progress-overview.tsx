...
function ProgressCardSkeleton({
  ...
  return (
    <Card className="rounded-2xl gap-3 p-4 md:p-5 animate-pulse">
...
function ProgressCardError({
  ...
  return (
    <Card className="rounded-2xl gap-3 p-4 md:p-5 border-red-200 bg-red-50">
      <div className="flex items-center gap-1 mb-3">
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <Card key={i} className="rounded-2xl gap-3 p-4 md:p-5 animate-pulse">
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
      ...
      {weightLoading ? (
        ...
        <Card className="rounded-2xl gap-3 p-4 md:p-5">
          <div className="flex items-center gap-1">
      ...
      {weightLoading ? (
        ...
        <ProgressCardError title="Weight Change" icon={isWeightLoss ? TrendingDown : TrendingUp} />
      ) : (
        <Card className="rounded-2xl gap-3 p-4 md:p-5">
          <div className="flex items-center gap-1">
            <h3 className="text-xs font-medium text-muted-foreground">
...
export function ProgressOverview() {
  return <ProgressOverviewContent />;
}
